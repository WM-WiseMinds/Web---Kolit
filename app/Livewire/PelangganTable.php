...
final class PelangganTable extends PowerGridComponent
{
    ...
    {
        return Detailpelanggan::query()->with('user');
    }
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ->add('id')
            ->add('user_id')
            ->add('name', function (Detailpelanggan $row) {
                return $row->user->name;
            })
            ->add('alamat')
            ->add('no_wa')
            ->add('created_at_formatted', function (Detailpelanggan $row) {
    ...
    public function actions(Detailpelanggan $row): array
    {
        $actions = [];
    ...
    {
        $pelanggan = Detailpelanggan::findOrFail($rowId);
        $pelanggan->delete();
